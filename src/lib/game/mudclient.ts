...
import applyUIComponents from './ui';
import getPacketHandlers from './packet-handlers';
import keycodes from './lib/keycodes.json';
import clientOpcodes from './opcodes/client.json';
...
class mudclient extends GameConnection {
	...
	localRegionX: number;
	localRegionY: number;
	messageTabSelected: number;
	mouseClickXX: number;
	mouseClickXY: number;
	privateMessageTarget: Long;
	controlListQuest: number;
	controlListMagic: number;
	packetErrorCount: number;
	mouseButtonDownTime: number;
	mouseButtonItemCountIncrement: number;
	animationIndex: number;
	cameraRotationX: number;
	tradeConfirmAccepted: boolean;
	appearanceHeadType: number;
	appearanceSkinColour: number;
	anInt707: number;
	deathScreenTimeout: number;
	cameraRotationY: number;
	welcomeUnreadMessages: number;
	logoutTimeout: number;
	tradeRecipientConfirmHash: Long;
	loginTimer: number;
	npcCombatModelArray1: Int32Array;
	npcCombatModelArray2: Int32Array;
	systemUpdate: number;
	regionX: number;
	regionY: number;
	welcomScreenAlreadyShown: boolean;
	mouseButtonClick: number;
	healthBarCount: number;
	spriteMedia: number;
	spriteUtil: number;
	spriteItem: number;
	spriteProjectile: number;
	spriteTexture: number;
	spriteTextureWorld: number;
	spriteLogo: number;
	teleportBubbleCount: number;
	mouseClickCount: number;
	shopSellPriceMod: number;
	shopBuyPriceMod: number;
	duelOptionRetreat: number;
	duelOptionMagic: number;
	duelOptionPrayer: number;
	duelOptionWeapons: number;
	groundItemCount: number;
	receivedMessagesCount: number;
	messageTabFlashAll: number;
	messageTabFlashHistory: number;
	messageTabFlashQuest: number;
	messageTabFlashPrivate: number;
	bankItemCount: number;
	objectAnimationNumberFireLightningSpell: number;
	objectAnimationNumberTorch: number;
	objectAnimationNumberClaw: number;
	loggedIn: number;
	npcCount: number;
	npcCacheCount: number;
	objectAnimationCount: number;
	tradeConfirmItemsCount: number;
	mouseClickXStep: number;
	newBankItemCount: number;
	npcAnimationArray: Int32Array[];
	npcWalkModel: Int32Array;
	referID: number;
	combatTimeout: number;
	optionMenuCount: number;
	errorLoadingCodebase: boolean;
	cameraRotationTime: number;
	duelOpponentItemsCount: number;
	duelItemsCount: number;
	duelOfferOpponentItemCount: number;
	characterHairColours: Int32Array;
	characterTopBottomColours: Int32Array;
	characterSkinColours: Int32Array;
	itemsAboveHeadCount: number;
	statFatigue: number;
	fatigueSleeping: number;
	tradeRecipientConfirmItemsCount: number;
	tradeRecipientItemsCount: number;
	showDialogServerMessage: boolean;
	menuX: number;
	menuY: number;
	menuWidth: number;
	menuHeight: number;
	...
	playerQuestPoints: number;
	welcomeLastLoggedInDays: number;
	inventoryItemsCount: number;
	duelOpponentNameHash: Long;
	minimapRandom1: number;
	minimapRandom2: number;
	objectCount: number;
	duelOfferItemCount: number;
	cameraAutoRotatePlayerX: number;
	cameraAutoRotatePlayerY: number;
	playerCount: number;
	knownPlayerCount: number;
	spriteCount: number;
	wallObjectCount: number;
	welcomeRecoverySetDays: number;
	localLowerX: number;
	localLowerY: number;
	localUpperX: number;
	localUpperY: number;
	world: any;
	welcomeLastLoggedInIP: number;
	sleepWordDelayTimer: number;
	menuIndices: Int32Array;
	cameraAutoAngleDebug: boolean;
	wallObjectDirection: Int32Array;
	wallObjectId: Int32Array;
	cameraRotationXIncrement: number;
	inventoryMaxItemCount: number;
	bankItemsMax: number;
	optionMenuEntry: any[];
	newBankItems: Int32Array;
	newBankItemsCount: Int32Array;
	teleportBubbleTime: Int32Array;
	receivedMessageX: Int32Array;
	receivedMessageY: Int32Array;
	receivedMessageMidPoint: Int32Array;
	receivedMessageHeight: Int32Array;
	localPlayer: GameCharacter;
	localPlayerServerIndex: number;
	menuItemX: Int32Array;
	menuItemY: Int32Array;
	bankItems: Int32Array;
	bankItemsCount: Int32Array;
	appearanceBodyGender: number;
	appearance2Colour: number;
	appearanceHairColour: number;
	appearanceTopColour: number;
	appearanceBottomColour: number;
	appearanceHeadGender: number;
	loginUser: string;
	loginPass: string;
	cameraAngle: number;
	members: boolean;
	optionSoundDisabled: boolean;
	showRightClickMenu: boolean;
	cameraRotationYIncrement: number;
	objectAlreadyInMenu: boolean[];
	menuItemText1: any[];
	duelOpponentName: string;
	lastObjectAnimationNumberFireLightningSpell: number;
	lastObjectAnimationNumberTorch: number;
	lastObjectAnimationNumberClaw: number;
	planeIndex: number;
	teleportBubbleX: Int32Array;
	errorLoadingData: boolean;
	playerExperience: Int32Array;
	tradeRecipientAccepted: boolean;
	tradeAccepted: boolean;
	mouseClickXHistory: Int32Array;
	mouseClickYHistory: Int32Array;
	playerServerIndexes: Int32Array;
	teleportBubbleY: Int32Array;
	receivedMessages: any[];
	showDialogDuelConfirm: boolean;
	duelAccepted: boolean;
	players: any[];
	prayerOn: boolean[];
	menuIndex: Int32Array;
	menuSourceIndex: Int32Array;
	menuTargetIndex: Int32Array;
	wallObjectAlreadyInMenu: boolean[];
	magicLoc: number;
	errorLoadingMemory: boolean;
	fogOfWar: boolean;
	gameWidth: number;
	gameHeight: number;
	tradeConfirmItems: Int32Array;
	tradeConfirmItemCount: Int32Array;
	tradeRecipientName: string;
	selectedSpell: number;
	showOptionMenu: boolean;
	playerStatCurrent: Int32Array;
	teleportBubbleType: Int32Array;
	showDialogShop: boolean;
	shopItem: Int32Array;
	shopItemCount: Int32Array;
	shopItemPrice: Int32Array;
	duelOfferOpponentAccepted: boolean;
	duelOfferAccepted: boolean;
	gameModels: any[];
	showDialogDuel: boolean;
	serverMessage: string;
	duelOpponentItems: Int32Array;
	duelOpponentItemCount: Int32Array;
	duelItems: Int32Array;
	duelItemCount: Int32Array;
	playerStatBase: Int32Array;
	npcsCache: any[];
	groundItemX: Int32Array;
	groundItemY: Int32Array;
	groundItemID: Int32Array;
	groundItemZ: Int32Array;
	bankSelectedItemSlot: number;
	bankSelectedItem: number;
	duelOfferOpponentItemId: Int32Array;
	duelOfferOpponentItemStack: Int32Array;
	messageHistoryTimeout: Int32Array;
	optionCameraModeAuto: boolean;
	objectX: Int32Array;
	objectY: Int32Array;
	objectId: Int32Array;
	objectDirection: Int32Array;
	selectedItemInventoryIndex: number;
	selectedItemName: string;
	loadingArea: boolean;
	tradeRecipientConfirmItems: Int32Array;
	tradeRecipientConfirmItemCount: Int32Array;
	tradeRecipientItems: Int32Array;
	tradeRecipientItemCount: Int32Array;
	menuType: Int32Array;
	questComplete: Int8Array;
	wallObjectModel: any[];
	actionBubbleX: Int32Array;
	actionBubbleY: Int32Array;
	cameraZoom: number;
	tradeItems: Int32Array;
	tradeItemCount: Int32Array;
	lastHeightOffset: number;
	duelSettingsRetreat: boolean;
	duelSettingsMagic: boolean;
	duelSettingsPrayer: boolean;
	duelSettingsWeapons: boolean;
	showDialogBank: boolean;
	loginUserDesc: string;
	loginUserDisp: string;
	optionMouseButtonOne: boolean;
	inventoryItemId: Int32Array;
	inventoryItemStackCount: Int32Array;
	inventoryEquipped: Int32Array;
	knownPlayers: any[];
	messageHistory: any[];
	duelOfferItemId: Int32Array;
	duelOfferItemStack: Int32Array;
	actionBubbleScale: Int32Array;
	actionBubbleItem: Int32Array;
	sleepWordDelay: boolean;
	showAppearanceChange: boolean;
	shopSelectedItemIndex: number;
	shopSelectedItemType: number;
	projectileMaxRange: number;
	npcs: any[];
	experienceArray: Int32Array;
	healthBarX: Int32Array;
	healthBarY: Int32Array;
	healthBarMissing: Int32Array;
	playerServer: any[];
	walkPathX: Int32Array;
	walkPathY: Int32Array;
	wallObjectX: Int32Array;
	wallObjectY: Int32Array;
	menuItemText2: any[];
	npcsServer: any[];
	playerStatEquipment: Int32Array;
	objectModel: any[];
	playerMsgHistory: any[];
	playerMsgPtr: number;
	recoveryQuestions: string[];
	showRecoverChange: boolean;
	recoverCustomQuestionIndex: number;
	showChangePasswordStep: number;
	changePasswordOld: string;
	changePasswordNew: string;
	welcomeTipDay: number;
	audioPlayer: any;
	surface: any;
	scene: any;
	showDialogWelcome: any;
	showUiWildWarn: number;
	showDialogTradeConfirm: any;
	showDialogTrade: any;
	showDialogReportAbuseStep: number;
	showDialogSocialInput: number;
	menuActionTimeout: any;
	menuTextWidth: any;
	combatStyle: number;
	isSleeping: boolean;
	panelLoginWelcome: Panel;
	panelLoginNewUser: Panel;
	panelLoginExistingUser: Panel;
	panelAppearance: Panel;
	panelMessageTabs: Panel;
	panelQuestList: Panel;
	panelMagic: Panel;
	panelSocialList: Panel;
	controlListSocialPlayers: any;
	isInWild: any;
	controlTextListChat: any;
	controlTextListQuest: any;
	controlTextListPrivate: any;
	soundData: any;
	menuText: string;
	constructor(canvas) {
		super(canvas);
		...
		this.characterTopBottomColours = new Int32Array([
			0xff0000, 0xff8000, 0xffe000, 0xa0e000, 0x00e000, 0x008000, 0x00a080, 0x00b0ff, 0x0080ff,
			0x0030f0, 0xe000e0, 0x303030, 0x604000, 0x805000, 0xffffff
		]);
		...
		this.objectAlreadyInMenu = Array(OBJECTS_MAX);
		this.menuItemText1 = [];
		...
		this.wallObjectAlreadyInMenu = Array(WALL_OBJECTS_MAX);
		this.magicLoc = 128;
	...
	drawAboveHeadStuff() {
		for (let i = 0; i < this.receivedMessagesCount; i++) {
			...
			while (flag) {
				...
				for (let j = 0; j < i; j++) {
					if (
						y + messageHeight > this.receivedMessageY[j] - textHeight &&
						y - textHeight < this.receivedMessageY[j] + this.receivedMessageHeight[j] &&
						x - messageMid < this.receivedMessageX[j] + this.receivedMessageMidPoint[j] &&
						x + messageMid > this.receivedMessageX[j] - this.receivedMessageMidPoint[j] &&
						this.receivedMessageY[j] - textHeight - messageHeight < y
					) {
		...
		for (let i = 0; i < this.itemsAboveHeadCount; i++) {
			...
			this.surface._spriteClipping_from9(
				x - ((scaleXClip / 2) | 0),
				y - scaleY + ((scaleY / 2) | 0) - ((scaleYClip / 2) | 0),
				scaleXClip,
				scaleYClip,
				GameData.itemPicture[id] + this.spriteItem,
				GameData.itemMask[id],
				0,
				0,
				false
			);
		...
		for (let i = 0; i < this.healthBarCount; i++) {
			...
			this.surface.drawBoxAlpha(x - 15 + missing, y - 3, 30 - missing, 5, 0xff0000, 192);
		}
	}
	...
	drawUiTabInventory(noMenus: boolean) {
		throw new Error('Method not implemented.');
	}
	drawUiTabMinimap(noMenus: boolean) {
		throw new Error('Method not implemented.');
	}
	drawUiTabPlayerInfo(noMenus: boolean) {
		throw new Error('Method not implemented.');
	}
	drawUiTabMagic(noMenus: boolean) {
		throw new Error('Method not implemented.');
	}
	drawUiTabSocial(noMenus: boolean) {
		throw new Error('Method not implemented.');
	}
	drawUiTabOptions(noMenus: boolean) {
		throw new Error('Method not implemented.');
	}
	...
	handleKeyPress(keyCode) {
		...
		if (this.loggedIn === 1) {
			...
			if (this.showChangePasswordStep === 3 || this.showChangePasswordStep === 4) {
				this.showChangePasswordStep = 0;
			}
		}
	}
	...
	async handleGameInput() {
		...
		for (let i = 0; i < this.playerCount; i++) {
			...
			if (player.movingStep !== k) {
				...
				if (
					player.waypointsX[l2] - player.currentX > this.magicLoc * 3 ||
					player.waypointsY[l2] - player.currentY > this.magicLoc * 3 ||
					player.waypointsX[l2] - player.currentX < -this.magicLoc * 3 ||
					player.waypointsY[l2] - player.currentY < -this.magicLoc * 3 ||
					j4 > 8
				) {
					...
					if (
						player.currentX - player.waypointsX[l2] < j5 &&
						player.currentX - player.waypointsX[l2] > -j5
					) {
						player.currentX = player.waypointsX[l2];
					}
					...
					if (
						player.currentY - player.waypointsY[l2] < j5 &&
						player.currentY - player.waypointsY[l2] > -j5
					) {
						player.currentY = player.waypointsY[l2];
					}
		...
		for (let i = 0; i < this.npcCount; i++) {
			...
			if (npc.movingStep !== j1) {
				...
				if (
					npc.waypointsX[k4] - npc.currentX > this.magicLoc * 3 ||
					npc.waypointsY[k4] - npc.currentY > this.magicLoc * 3 ||
					npc.waypointsX[k4] - npc.currentX < -this.magicLoc * 3 ||
					npc.waypointsY[k4] - npc.currentY < -this.magicLoc * 3 ||
					k5 > 8
				) {
		...
		if (this.cameraAutoAngleDebug) {
			...
			if (this.cameraAutoRotatePlayerX !== this.localPlayer.currentX) {
				this.cameraAutoRotatePlayerX +=
					((this.localPlayer.currentX - this.cameraAutoRotatePlayerX) /
						(16 + (((this.cameraZoom - 500) / 15) | 0))) |
					0;
			}

			if (this.cameraAutoRotatePlayerY !== this.localPlayer.currentY) {
				this.cameraAutoRotatePlayerY +=
					((this.localPlayer.currentY - this.cameraAutoRotatePlayerY) /
						(16 + (((this.cameraZoom - 500) / 15) | 0))) |
					0;
			}
	...
	drawRightClickMenu() {
		...
		for (let i = 0; i < this.menuItemsCount; i++) {
			...
			this.surface.drawString(
				this.menuItemText1[this.menuIndices[i]] + ' ' + this.menuItemText2[this.menuIndices[i]],
				entryX,
				entryY,
				1,
				textColour
	...
	drawNpc(x, y, w, h, id, tx, ty) {
		...
		let j2 =
			i2 * 3 + this.npcWalkModel[((npc.stepCount / GameData.npcWalkModel[npc.npcId]) | 0) % 4];
		...
		if (npc.animationCurrent === 8) {
			...
			j2 =
				...
				this.npcCombatModelArray1[
					(((this.loginTimer / GameData.npcCombatModel[npc.npcId]) | 0) - 1) % 8
				];
			...
			j2 =
				i2 * 3 +
				this.npcCombatModelArray2[((this.loginTimer / GameData.npcCombatModel[npc.npcId]) | 0) % 8];
		}
		...
		for (let k2 = 0; k2 < 12; k2++) {
			...
			if (k3 >= 0) {
				...
				if (i2 !== 5 || GameData.animationHasA[k3] === 1) {
					...
					let i5 =
						((w * this.surface.spriteWidthFull[l4]) /
							this.surface.spriteWidthFull[GameData.animationNumber[k3]]) |
						0;
		...
		if (npc.messageTimeout > 0) {
			this.receivedMessageMidPoint[this.receivedMessagesCount] =
				(this.surface.textWidth(npc.message, 1) / 2) | 0;
			...
			this.receivedMessageHeight[this.receivedMessagesCount] =
				((this.surface.textWidth(npc.message, 1) / 300) | 0) * this.surface.textHeight(1);
	...
	drawDialogDuel() {
		...
		for (let i = 0; i < this.duelOfferItemCount; i++) {
			...
			this.surface._spriteClipping_from9(
				...
				48,
				32,
				this.spriteItem + GameData.itemPicture[this.duelOfferItemId[i]],
				GameData.itemMask[this.duelOfferItemId[i]],
				0,
				0,
				false
			);
			...
			if (this.mouseX > x && this.mouseX < x + 48 && this.mouseY > y && this.mouseY < y + 32) {
				this.surface.drawString(
					GameData.itemName[this.duelOfferItemId[i]] +
						': @whi@' +
		...
		for (let i = 0; i < this.duelOfferOpponentItemCount; i++) {
			...
			this.surface._spriteClipping_from9(
				...
				48,
				32,
				this.spriteItem + GameData.itemPicture[this.duelOfferOpponentItemId[i]],
				GameData.itemMask[this.duelOfferOpponentItemId[i]],
				0,
				0,
				false
			);
			...
			if (this.mouseX > x && this.mouseX < x + 48 && this.mouseY > y && this.mouseY < y + 32) {
				this.surface.drawString(
					GameData.itemName[this.duelOfferOpponentItemId[i]] +
						': @whi@' +
						GameData.itemDescription[this.duelOfferOpponentItemId[i]],
					dialogX + 8,
					dialogY + 273,
					1,
					0xffff00
	...
	drawPlayer(x, y, w, h, id, tx, ty) {
		...
		for (let k2 = 0; k2 < 12; k2++) {
			...
			if (l3 >= 0) {
				...
				if (i2 !== 5 || GameData.animationHasA[l3] === 1) {
					...
					let l5 =
						((w * this.surface.spriteWidthFull[k5]) /
							this.surface.spriteWidthFull[GameData.animationNumber[l3]]) |
						0;

					k4 -= ((l5 - w) / 2) | 0;

					let i6 = GameData.animationCharacterColour[l3];
					const skinColour = this.characterSkinColours[player.colourSkin];
		...
		if (player.messageTimeout > 0) {
			this.receivedMessageMidPoint[this.receivedMessagesCount] =
				(this.surface.textWidth(player.message, 1) / 2) | 0;
			...
			this.receivedMessageHeight[this.receivedMessagesCount] =
				((this.surface.textWidth(player.message, 1) / 300) | 0) * this.surface.textHeight(1);
			this.receivedMessageX[this.receivedMessagesCount] = x + ((w / 2) | 0);
			this.receivedMessageY[this.receivedMessagesCount] = y;
	...
	async loadMedia() {
		const mediaJag = await this.readDataFile(`media${version.MEDIA}.jag`, '2d graphics', 20);
		...
		this.surface.parseSprite(
			this.spriteMedia,
			Utility.loadData('inv1.dat', 0, mediaJag),
			indexDat,
			1
		);
		this.surface.parseSprite(
			this.spriteMedia + 1,
			Utility.loadData('inv2.dat', 0, mediaJag),
			indexDat,
			6
		);
		this.surface.parseSprite(
			this.spriteMedia + 9,
			Utility.loadData('bubble.dat', 0, mediaJag),
			indexDat,
			1
		);
		this.surface.parseSprite(
			this.spriteMedia + 10,
			Utility.loadData('runescape.dat', 0, mediaJag),
			indexDat,
			1
		);
		this.surface.parseSprite(
			this.spriteMedia + 11,
			Utility.loadData('splat.dat', 0, mediaJag),
			indexDat,
			3
		);
		this.surface.parseSprite(
			this.spriteMedia + 14,
			Utility.loadData('icon.dat', 0, mediaJag),
			indexDat,
			8
		);
		this.surface.parseSprite(
			this.spriteMedia + 22,
			Utility.loadData('hbar.dat', 0, mediaJag),
			indexDat,
			1
		);
		this.surface.parseSprite(
			this.spriteMedia + 23,
			Utility.loadData('hbar2.dat', 0, mediaJag),
			indexDat,
			1
		);
		this.surface.parseSprite(
			this.spriteMedia + 24,
			Utility.loadData('compass.dat', 0, mediaJag),
			indexDat,
			1
		);
		this.surface.parseSprite(
			this.spriteMedia + 25,
			Utility.loadData('buttons.dat', 0, mediaJag),
			indexDat,
			2
		);
		this.surface.parseSprite(
			this.spriteUtil,
			Utility.loadData('scrollbar.dat', 0, mediaJag),
			indexDat,
			2
		);
		this.surface.parseSprite(
			this.spriteUtil + 2,
			Utility.loadData('corners.dat', 0, mediaJag),
			indexDat,
			4
		);
		this.surface.parseSprite(
			this.spriteUtil + 6,
			Utility.loadData('arrows.dat', 0, mediaJag),
			indexDat,
			2
		);
		this.surface.parseSprite(
			this.spriteProjectile,
			Utility.loadData('projectile.dat', 0, mediaJag),
			indexDat,
	...
	async startGame() {
		...
		this.surface = new Surface(this.gameWidth, this.gameHeight + 12, 4000, this);
		...
		this.controlListQuest = this.panelQuestList.addTextListInteractive(
			x,
			y + 24,
			196,
			251,
		...
		this.controlListMagic = this.panelMagic.addTextListInteractive(
			x,
			y + 24,
			196,
			90,
		...
		this.controlListSocialPlayers = this.panelSocialList.addTextListInteractive(
			x,
			y + 40,
			196,
			126,
	...
	hasInventoryItems(id, minimum) {
		if (
			id === 31 &&
			(this.isItemEquipped(197) || this.isItemEquipped(615) || this.isItemEquipped(682))
		) {
			return true;
		}
		...
		if (
			id === 32 &&
			(this.isItemEquipped(102) || this.isItemEquipped(616) || this.isItemEquipped(683))
		) {
			return true;
		}
		...
		if (
			id === 33 &&
			(this.isItemEquipped(101) || this.isItemEquipped(617) || this.isItemEquipped(684))
		) {
			return true;
		}
		...
		if (
			id === 34 &&
			(this.isItemEquipped(103) || this.isItemEquipped(618) || this.isItemEquipped(685))
		) {
			return true;
		}
	...
	drawGame() {
			...
			if (this.options.showRoofs) {
				...
				if (
					...
					(this.world.objectAdjacency.get(
						(this.localPlayer.currentX / 128) | 0,
						(this.localPlayer.currentY / 128) | 0
					) &
						128) ===
						0
				) {
		...
		if (
			...
			for (let i = 0; i < this.objectCount; i++) {
				...
				if (this.objectId[i] === 1031) {
					this.updateObjectAnimation(
						i,
						'lightning' + (this.objectAnimationNumberFireLightningSpell + 1)
					);
				}
				...
				if (this.objectId[i] === 1147) {
					this.updateObjectAnimation(
						i,
						'spellcharge' + (this.objectAnimationNumberFireLightningSpell + 1)
					);
				}
			}
		}
		...
		for (let i = 0; i < this.playerCount; i++) {
			...
			if (player.projectileRange > 0) {
				...
				if (character) {
					...
					const delev = -(
						(this.world.getElevation(dx, dy) - GameData.npcHeight[character.npcId] / 2) |
						0
					);
					const rx =
						((sx * player.projectileRange +
							dx * (this.projectileMaxRange - player.projectileRange)) /
							this.projectileMaxRange) |
						0;
					const rz =
						((selev * player.projectileRange +
							delev * (this.projectileMaxRange - player.projectileRange)) /
							this.projectileMaxRange) |
						0;
					const ry =
						((sy * player.projectileRange +
							dy * (this.projectileMaxRange - player.projectileRange)) /
							this.projectileMaxRange) |
						0;
		...
		for (let i = 0; i < this.npcCount; i++) {
			...
			const i9 = this.scene.addSprite(
				...
				i7,
				j4,
				GameData.npcWidth[npc.npcId],
				GameData.npcHeight[npc.npcId],
				i + 30000
			);
		...
		if (this.mouseClickXStep > 0) {
			this.surface._drawSprite_from3(
				this.mouseClickXX - 8,
				this.mouseClickXY - 8,
				this.spriteMedia + 14 + (((24 - this.mouseClickXStep) / 6) | 0)
			);
		}
		...
		if (this.mouseClickXStep < 0) {
			this.surface._drawSprite_from3(
				this.mouseClickXX - 8,
				this.mouseClickXY - 8,
				this.spriteMedia + 18 + (((24 + this.mouseClickXStep) / 6) | 0)
			);
		}
		...
		if (this.systemUpdate !== 0) {
			...
			if (seconds < 10) {
				this.surface.drawStringCenter(
					'System update in: ' + minutes + ':0' + seconds,
					256,
					this.gameHeight - 7,
					1,
					0xffff00
	...
	isItemEquipped(id) {
		for (let i = 0; i < this.inventoryItemsCount; i++) {
			if (this.inventoryItemId[i] === id && this.inventoryEquipped[i] === 1) {
				return true;
			}
		}
	...
	async loadEntities() {
		...
		label0: for (let j = 0; j < GameData.animationCount; j++) {
	...
	drawDialogDuelConfirm() {
		...
		this.surface.drawStringCenter(
			'Please confirm your duel with @yel@' + Utility.hashToUsername(this.duelOpponentNameHash),
			dialogX + 234,
			dialogY + 12,
			1,
			0xffffff
	...
	async loadModels() {
		...
		const modelsJag = await this.readDataFile(`models${version.MODELS}.jag`, '3d models', 60);
		...
		for (let i = 0; i < GameData.modelCount; i++) {
			const offset = Utility.getDataFileOffset(`${GameData.modelName[i]}.ob3`, modelsJag);
	...
	showMessage(message, type) {
		...
		if (type === 2) {
			if (
				this.panelMessageTabs.controlFlashText[this.controlTextListChat] ===
				this.panelMessageTabs.controlListEntryCount[this.controlTextListChat] - 4
			) {
			...
			if (
				this.panelMessageTabs.controlFlashText[this.controlTextListQuest] ===
				this.panelMessageTabs.controlListEntryCount[this.controlTextListQuest] - 4
			) {
			...
			if (
				this.panelMessageTabs.controlFlashText[this.controlTextListPrivate] ===
				this.panelMessageTabs.controlListEntryCount[this.controlTextListPrivate] - 4
			) {
	...
	async loadTextures() {
		...
		for (let i = 0; i < GameData.textureCount; i++) {
			...
			this.scene.defineTexture(
				i,
				this.surface.spriteColoursUsed[this.spriteTextureWorld + i],
				this.surface.spriteColourList[this.spriteTextureWorld + i],
				((wh / 64) | 0) - 1
			);
		}
	}
		...
		for (let i = 10; i < 4000; i++) {
			...
			if (this.mouseClickXHistory[i1] === x && this.mouseClickYHistory[i1] === y) {
				...
				for (let j1 = 1; j1 < i; j1++) {
					...
					if (
						this.mouseClickXHistory[k1] !== this.mouseClickXHistory[l1] ||
						this.mouseClickYHistory[k1] !== this.mouseClickYHistory[l1]
					) {
						break;
					}
	...
	createTopMouseMenu() {
		...
		if (this.menuItemsCount > 0) {
			...
			for (let i1 = 0; i1 < this.menuItemsCount; i1++) {
				if (
					this.menuItemText2[this.menuIndices[i1]] === null ||
			...
			if (
				(this.selectedItemInventoryIndex >= 0 || this.selectedSpell >= 0) &&
			...
			if (
				...
				(this.optionMouseButtonOne && this.mouseButtonClick === 1 && this.menuItemsCount === 1)
			) {
			...
			if (
				...
				for (let k1 = 0; k1 < this.menuItemsCount; k1++) {
					let l1 =
						this.surface.textWidth(this.menuItemText1[k1] + ' ' + this.menuItemText2[k1], 1) + 5;
	...
	menuItemClick(i) {
		...
		switch (menuType) {
			case 200:
				this.walkToGroundItem(this.localRegionX, this.localRegionY, menuX, menuY, true);
			...
			case 650:
				...
				this.selectedItemName =
					GameData.itemName[this.inventoryItemId[this.selectedItemInventoryIndex]];
				break;
			case 660:
				...
				this.showMessage('Dropping ' + GameData.itemName[this.inventoryItemId[menuIndex]], 4);
				break;
			case 3600:
				this.showMessage(GameData.itemDescription[menuIndex], 3);
				break;
			case 700: {
				...
				this._walkToActionSource_from5(this.localRegionX, this.localRegionY, x, y, true);
			...
			case 2820:
				...
				break;
			case 900:
				this._walkToActionSource_from5(this.localRegionX, this.localRegionY, menuX, menuY, true);
				...
				break;
			case 920:
				this._walkToActionSource_from5(this.localRegionX, this.localRegionY, menuX, menuY, false);
	...
	controlRegisterStatus(controlRegisterStatus: any, arg1: string) {
		throw new Error('Method not implemented.');
	}
	controlLoginStatus(controlLoginStatus: any, arg1: string) {
		throw new Error('Method not implemented.');
	}
		...
		for (let l = 2; l >= 1; l--) {
			if (
				...
				((this.world.objectAdjacency.get(x, y - l) & 128) === 128 ||
					...
					(this.world.objectAdjacency.get(x - l, y - l) & 128) === 128)
			) {
				return false;
			}
		...
		try {
			...
			if (this.packetErrorCount < 3) {
				...
				this.packetStream.putShort(
					(messageLength = (errorMessage = 'p-type: ' + opcode + ' p-size:' + size).length)
				);
				this.packetStream.putString(errorMessage);
				this.packetStream.putShort(
					(messageLength = (errorMessage =
						'rx:' + this.localRegionX + ' ry:' + this.localRegionY + ' num3l:' + this.objectCount)
						.length)
				);
				this.packetStream.putString(errorMessage);
	...
	createRightClickMenu() {
		...
		for (let menuIdx = 0; menuIdx < i1; menuIdx++) {
			...
			if (
				...
				(gameModel.faceTag[pid] >= 200000 && gameModel.faceTag[pid] <= 300000)
			) {
				if (gameModel === this.scene.view) {
					...
					if (type === 1) {
						...
						if (this.selectedSpell >= 0) {
							...
							if (
								i > 0 &&
								(((this.players[idx].currentY - 64) / this.magicLoc +
									this.planeHeight +
									this.regionY) |
									0) <
									2203
						...
						if (this.selectedSpell >= 0) {
							if (GameData.spellType[this.selectedSpell] === 3) {
								this.menuItemText1[this.menuItemsCount] =
									'Cast ' + GameData.spellName[this.selectedSpell] + ' on';
								this.menuItemText2[this.menuItemsCount] =
									'@lre@' + GameData.itemName[this.groundItemID[idx]];
						...
						if (this.selectedSpell >= 0) {
							if (GameData.spellType[this.selectedSpell] === 2) {
								this.menuItemText1[this.menuItemsCount] =
									'Cast ' + GameData.spellName[this.selectedSpell] + ' on';
								this.menuItemText2[this.menuItemsCount] =
									'@yel@' + GameData.npcName[this.npcs[idx].npcId];
							...
							if (GameData.npcAttackable[id] > 0) {
								this.menuItemText1[this.menuItemsCount] = 'Attack';
								this.menuItemText2[this.menuItemsCount] =
									'@yel@' + GameData.npcName[this.npcs[idx].npcId] + menuText;
		...
		if (this.selectedSpell >= 0 && GameData.spellType[this.selectedSpell] <= 1) {
			this.menuItemText1[this.menuItemsCount] =
				'Cast ' + GameData.spellName[this.selectedSpell] + ' on self';
			this.menuItemText2[this.menuItemsCount] = '';
		...
		if (j !== -1) {
			if (this.selectedSpell >= 0) {
				if (GameData.spellType[this.selectedSpell] === 6) {
					this.menuItemText1[this.menuItemsCount] =
						'Cast ' + GameData.spellName[this.selectedSpell] + ' on ground';
					this.menuItemText2[this.menuItemsCount] = '';
	...
	async handleInputs() {
		if (this.errorLoadingCodebase || this.errorLoadingMemory || this.errorLoadingData) {
			return;
		}
